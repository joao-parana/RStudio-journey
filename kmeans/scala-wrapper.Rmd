...
Partindo do dataset original vamos inserir 130.299 registros com pelo menos um 
atributo null e gerar mais registros usando operação map do Dataset do Spark. 
O Dataset original é 3D_spatial_network.csv
